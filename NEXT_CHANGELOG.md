...
* Allow users to override the Terraform version to use by setting the `DATABRICKS_TF_VERSION_OVERRIDE` environment variable ([#3069](https://github.com/databricks/cli/pull/3069))
