...
func testListRows() []listRow {
	return []listRow{
		...
		{RunID: "2", Experiment: "llama-train", User: "me@example.com", Status: "RUNNING", StartedAt: new("2026-06-05T18:43:24.000000+00:00"), Duration: "3m 32s", ETA: "~48m 20s", MLflowURL: "-", MLflowLabel: "-", Accelerators: "1x A10"},
