...
databricks experimental mcp --warehouse-id <warehouse-id> --with-workspace-tools

# Enable deployment
databricks experimental mcp --warehouse-id <warehouse-id> --allow-deployment

# With custom Docker image
databricks experimental mcp --warehouse-id <warehouse-id> --docker-image node:20-alpine

# Without containerized validation
databricks experimental mcp --warehouse-id <warehouse-id> --use-dagger=false
