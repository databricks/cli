...
The 'my_default_python' project was generated by using the Lakeflow Pipelines template.

* `lib/`: Python source code for this project.
* `lib/shared`: Shared source code across all jobs/pipelines/etc.
* `resources/default_python_etl`: Pipeline code and assets for the default_python_etl pipeline.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/default_python_etl/default_python_job.job.yml). The schedule
