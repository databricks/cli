...
Guidance for AI coding agents working in the **my_default_python** project. This
...
- `src/` — Python source for the jobs and pipelines.
  - `src/my_default_python/` — shared Python code used by jobs and pipelines.
- `tests/`, `fixtures/` — unit tests and test data.
...
- `uv run pytest` — run the unit tests after changing Python under `src/`.
