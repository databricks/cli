...
Guidance for AI coding agents working in the **my_default_scala** project. This
...
- `build.sbt`, `project/` — the sbt build for the Scala sources; `sbt package`
  produces the JAR that the jobs run.
...
- `databricks bundle run <resource_key>` — run a job.
