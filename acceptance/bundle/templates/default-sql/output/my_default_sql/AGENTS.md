...
Guidance for AI coding agents working in the **my_default_sql** project. This
...
- `src/` — SQL source for the jobs.
- `scratch/` — a place for exploratory notebooks; not deployed by default.
