...
var getAssignableRolesForResourceCmd = &cobra.Command{
  ...
  role.`,
	...
	RunE: func(cmd *cobra.Command, args []string) (err error) {
		...
		response, err := w.AccessControlProxy.GetAssignableRolesForResource(ctx, getAssignableRolesForResourceReq)
		if err != nil {
			return err
		}
...
var getRuleSetCmd = &cobra.Command{
  ...
  rule set for each resource is supported.`,
	...
	RunE: func(cmd *cobra.Command, args []string) (err error) {
		...
		response, err := w.AccessControlProxy.GetRuleSet(ctx, getRuleSetReq)
		if err != nil {
			return err
		}
		return cmdio.Render(ctx, response)
...
var updateRuleSetCmd = &cobra.Command{
  ...
  prevent conflicts between concurrent updates.`,
	...
	RunE: func(cmd *cobra.Command, args []string) (err error) {
		...
		response, err := w.AccessControlProxy.UpdateRuleSet(ctx, updateRuleSetReq)
		if err != nil {
			return err
		}
		return cmdio.Render(ctx, response)
