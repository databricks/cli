...
func newCreateTagAssignment() *cobra.Command {
  ...
  Arguments:
    ENTITY_TYPE: The type of entity to which the tag is assigned. Allowed value is
      dashboards
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) (err error) {
		...
		response, err := w.TagAssignments.CreateTagAssignment(ctx, createTagAssignmentReq)
		if err != nil {
			return err
		}
...
func newDeleteTagAssignment() *cobra.Command {
  ...
  Arguments:
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) (err error) {
		...
		err = w.TagAssignments.DeleteTagAssignment(ctx, deleteTagAssignmentReq)
		if err != nil {
			return err
		}
		return nil
...
func newGetTagAssignment() *cobra.Command {
  ...
  Arguments:
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) (err error) {
		...
		response, err := w.TagAssignments.GetTagAssignment(ctx, getTagAssignmentReq)
		if err != nil {
			return err
		}
		return cmdio.Render(ctx, response)
...
func newListTagAssignments() *cobra.Command {
  ...
  Arguments:
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) (err error) {
		...
		response := w.TagAssignments.ListTagAssignments(ctx, listTagAssignmentsReq)
...
func newUpdateTagAssignment() *cobra.Command {
  ...
  Arguments:
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) (err error) {
		...
		response, err := w.TagAssignments.UpdateTagAssignment(ctx, updateTagAssignmentReq)
		if err != nil {
			return err
		}
		return cmdio.Render(ctx, response)
