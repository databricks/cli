...
func newCreateFeatureTag() *cobra.Command {
	...
	cmd.Flags().StringVar(&createFeatureTagReq.FeatureTag.Key, "key", createFeatureTagReq.FeatureTag.Key, ``)
	cmd.Flags().StringVar(&createFeatureTagReq.FeatureTag.Value, "value", createFeatureTagReq.FeatureTag.Value, ``)

	cmd.Use = "create-feature-tag TABLE_NAME FEATURE_NAME"
...
func newUpdateFeatureTag() *cobra.Command {
	...
	cmd.Flags().StringVar(&updateFeatureTagReq.FeatureTag.Key, "key", updateFeatureTagReq.FeatureTag.Key, ``)
