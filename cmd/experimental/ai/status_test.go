...
func TestStatusRunInvalidID(t *testing.T) {
...
func TestStatusRunNotFound(t *testing.T) {
	m := mocks.NewMockWorkspaceClient(t)
...
func TestStatusTemplateSweepNoTasks(t *testing.T) {
...
func TestStatusTemplateMinimal(t *testing.T) {
	// Only the always-present rows render; optional rows are hidden when empty.
	out := renderStatus(t, statusData{RunID: "1", Status: "PENDING", DashboardURL: "https://example.test/1"})
...
func TestStatusTemplateAllFields(t *testing.T) {
