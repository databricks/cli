...
func newCreate() *cobra.Command {
	...
	var createReq iam.CreateAccountServicePrincipalRequest
  ...
  Creates a new service principal in the Databricks account.`
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) (err error) {
		...
		response, err := a.ServicePrincipalsV2.Create(ctx, createReq)
		if err != nil {
			return err
		}
...
func newDelete() *cobra.Command {
  ...
  Arguments:
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) (err error) {
		...
		err = a.ServicePrincipalsV2.Delete(ctx, deleteReq)
		if err != nil {
			return err
		}
		return nil
...
func newGet() *cobra.Command {
  ...
  Arguments:
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) (err error) {
		...
		response, err := a.ServicePrincipalsV2.Get(ctx, getReq)
		if err != nil {
			return err
		}
		return cmdio.Render(ctx, response)
...
func newList() *cobra.Command {
  ...
  Gets the set of service principals associated with a Databricks account.`
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) (err error) {
		...
		response := a.ServicePrincipalsV2.List(ctx, listReq)
...
func newPatch() *cobra.Command {
	...
	var patchReq iam.PatchAccountServicePrincipalRequest
  ...
  Arguments:
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) (err error) {
		...
		err = a.ServicePrincipalsV2.Patch(ctx, patchReq)
		if err != nil {
			return err
		}
		return nil
...
func newUpdate() *cobra.Command {
	...
	var updateReq iam.UpdateAccountServicePrincipalRequest
  ...
  Arguments:
	...
	cmd.RunE = func(cmd *cobra.Command, args []string) (err error) {
		...
		err = a.ServicePrincipalsV2.Update(ctx, updateReq)
		if err != nil {
			return err
		}
		return nil
...
// end service AccountServicePrincipalsV2
