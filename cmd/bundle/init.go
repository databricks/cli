...
func newInitCommand() *cobra.Command {
	...
	cmd.Flags().StringVar(&templateDir, "template-directory", "", "Directory within repository that holds the template specification, that is the databricks_template_schema.json file.")
