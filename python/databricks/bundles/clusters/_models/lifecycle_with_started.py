...
class LifecycleWithStarted:
    ...
    @classmethod
    def from_dict(cls, value: "LifecycleWithStartedDict") -> "Self":
        return _transform(cls, value)

    def as_dict(self) -> "LifecycleWithStartedDict":
        return _transform_to_json_value(self)  # type:ignore


class LifecycleWithStartedDict(TypedDict, total=False):
    """"""
...
LifecycleWithStartedParam = LifecycleWithStartedDict | LifecycleWithStarted
