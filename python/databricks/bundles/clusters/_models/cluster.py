...
class Cluster(Resource):
    ...
    * [use_ml_runtime](/api/workspace/clusters/create#use_ml_runtime)
    ...
    permissions: VariableOrList[ClusterPermission] = field(default_factory=list)
    """
    ...
    @classmethod
    def from_dict(cls, value: "ClusterDict") -> "Self":
        return _transform(cls, value)

    def as_dict(self) -> "ClusterDict":
...
class ClusterDict(TypedDict, total=False):
    ...
    * [use_ml_runtime](/api/workspace/clusters/create#use_ml_runtime)
    ...
    permissions: VariableOrList[ClusterPermissionParam]
    """
    The permissions to apply to this resource.
    """
...
ClusterParam = ClusterDict | Cluster
