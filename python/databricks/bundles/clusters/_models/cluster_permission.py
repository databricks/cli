...
class ClusterPermission:
    ...
    @classmethod
    def from_dict(cls, value: "ClusterPermissionDict") -> "Self":
        return _transform(cls, value)

    def as_dict(self) -> "ClusterPermissionDict":
        return _transform_to_json_value(self)  # type:ignore


class ClusterPermissionDict(TypedDict, total=False):
    """"""

    level: VariableOr[ClusterPermissionLevelParam]
    """
    The permission level to apply. The allowed levels depend on the resource type.
    """
...
ClusterPermissionParam = ClusterPermissionDict | ClusterPermission
