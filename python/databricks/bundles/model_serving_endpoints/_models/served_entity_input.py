...
class ServedEntityInput:
    ...
    burst_scaling_enabled: VariableOrOptional[bool] = None
    """
    [Public Preview] Whether burst scaling is enabled. When enabled (default), the endpoint can automatically
...
class ServedEntityInputDict(TypedDict, total=False):
    ...
    burst_scaling_enabled: VariableOrOptional[bool]
    """
    [Public Preview] Whether burst scaling is enabled. When enabled (default), the endpoint can automatically
    scale up beyond provisioned capacity to handle traffic spikes. When disabled, the endpoint
    maintains fixed capacity at provisioned_model_units.
