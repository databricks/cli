...
class SqlWarehousePermission:
    """"""

    level: VariableOr[WarehousePermissionLevel]
    """
    ...
    @classmethod
    def from_dict(cls, value: "SqlWarehousePermissionDict") -> "Self":
        return _transform(cls, value)

    def as_dict(self) -> "SqlWarehousePermissionDict":
        return _transform_to_json_value(self)  # type:ignore


class SqlWarehousePermissionDict(TypedDict, total=False):
    """"""

    level: VariableOr[WarehousePermissionLevelParam]
    """
    The permission level to apply. The allowed levels depend on the resource type.
    """
...
SqlWarehousePermissionParam = SqlWarehousePermissionDict | SqlWarehousePermission
