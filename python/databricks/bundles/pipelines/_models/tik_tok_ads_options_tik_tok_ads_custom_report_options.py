...
class TikTokAdsOptionsTikTokAdsCustomReportOptions:
    ...
    @classmethod
    def from_dict(cls, value: 'TikTokAdsOptionsTikTokAdsCustomReportOptionsDict') -> 'Self':
...
TikTokAdsOptionsTikTokAdsCustomReportOptionsParam = TikTokAdsOptionsTikTokAdsCustomReportOptionsDict | TikTokAdsOptionsTikTokAdsCustomReportOptions
