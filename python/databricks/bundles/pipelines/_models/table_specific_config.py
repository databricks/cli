...
class TableSpecificConfig:
    ...
    query_based_connector_config: VariableOrOptional[IngestionPipelineDefinitionTableSpecificConfigQueryBasedConnectorConfig] = None
    """
...
class TableSpecificConfigDict(TypedDict, total=False):
    ...
    query_based_connector_config: VariableOrOptional[IngestionPipelineDefinitionTableSpecificConfigQueryBasedConnectorConfigParam]
    """
    [Public Preview] Configurations that are only applicable for query-based ingestion connectors.
    """
