...
class MetaMarketingOptions:
    ...
    custom_report_options: VariableOrOptional[MetaMarketingOptionsMetaMarketingCustomReportOptions] = None
    """
...
class MetaMarketingOptionsDict(TypedDict, total=False):
    ...
    custom_report_options: VariableOrOptional[MetaMarketingOptionsMetaMarketingCustomReportOptionsParam]
    """
    :meta private: [EXPERIMENTAL]
