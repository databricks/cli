...
class TikTokAdsOptions:
    ...
    """
    custom_report_options: VariableOrOptional[TikTokAdsOptionsTikTokAdsCustomReportOptions] = None
    """
    :meta private: [EXPERIMENTAL]
...
class TikTokAdsOptionsDict(TypedDict, total=False):
    ...
    custom_report_options: VariableOrOptional[TikTokAdsOptionsTikTokAdsCustomReportOptionsParam]
    """
    :meta private: [EXPERIMENTAL]
