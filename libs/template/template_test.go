...
func TestTemplateHelpDescriptions(t *testing.T) {
	expected := `- default-python: The default Python template, using Python files or notebooks with Lakeflow
...
func TestTemplateOptions(t *testing.T) {
	expected := []cmdio.Tuple{
		{Name: "default-python", Id: "The default Python template, using Python files or notebooks with Lakeflow"},
