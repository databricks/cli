...
var allTemplates = []Template{
	{
		...
		Writer:      &writerWithFullTelemetry{defaultWriter: defaultWriter{templateName: DefaultPython}},
	},
	{
		name:        DefaultSql,
		description: "The default SQL template for .sql files that run with Databricks SQL",
		Reader:      &builtinReader{name: "default-sql"},
		Writer:      &writerWithFullTelemetry{defaultWriter: defaultWriter{templateName: DefaultSql}},
	},
	{
		name:        DbtSql,
		...
		Writer:      &writerWithFullTelemetry{defaultWriter: defaultWriter{templateName: DbtSql}},
	},
	{
		name:        MlopsStacks,
		...
		Writer:      &writerWithFullTelemetry{defaultWriter: defaultWriter{templateName: MlopsStacks}},
	},
	{
		name:        DefaultPydabs,
		hidden:      true,
		...
		Writer:      &writerWithFullTelemetry{defaultWriter: defaultWriter{templateName: DefaultPydabs}},
	},
	{
		name:        Custom,
		description: "Bring your own template",
		Reader:      &failReader{},
		Writer:      &defaultWriter{templateName: Custom},
	},
}
