...
func TestNormalizeServerAddressRejectsNonHTTPSURL(t *testing.T) {
	...
	require.ErrorContains(t, err, "unsupported registry URL scheme")
}
...
func TestNormalizeServerAddressRejectsNonHTTPSPort(t *testing.T) {
	_, err := normalizeServerAddress("https://123.container.us-west-2.cloud.databricks.com:5000")
	require.ErrorContains(t, err, "unsupported registry port")
}

func TestNormalizeServerAddressAllowsHTTPSPort(t *testing.T) {
	got, err := normalizeServerAddress("https://123.container.us-west-2.cloud.databricks.com:443")
	require.NoError(t, err)
	require.Equal(t, "123.container.us-west-2.cloud.databricks.com", got)
}
