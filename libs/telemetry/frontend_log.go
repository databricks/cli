...
type DatabricksCliLog struct {
	ExecutionContext events.ExecutionContext `json:"execution_context,omitempty"`
	...
	BundleDeployEvent *events.BundleDeployEvent `json:"bundle_deploy_event,omitempty"`
}
