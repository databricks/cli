...
## Current Usage
- `cmd/workspace/apps/logs.go` wires this helper into the `databricks workspace apps logs` command (tail/follow, filtering, multi-output). Use that command as a reference implementation before introducing new variants.
