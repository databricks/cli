...
// The Terraform deployment engine was removed in v1.18.0; automatic in-place
// migration is reintroduced separately.
const TerraformStateRemovedMessage = `this deployment's state uses the Terraform engine, which has been removed in Databricks CLI v1.18.0

Run "databricks bundle deployment migrate" to convert the state to the direct engine, or downgrade to CLI v1.17.x`
