...
func TestExpandGlobFilesSource(t *testing.T) {
	...
	diags := bundle.Apply(context.Background(), b, bundle.Seq(pm, bm, u, libraries.ExpandGlobReferences()))
...
func TestExpandGlobFilesSourceWithNoMatches(t *testing.T) {
	...
	diags := bundle.Apply(context.Background(), b, bundle.Seq(bm, u, libraries.ExpandGlobReferences()))
