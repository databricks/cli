...
type Descriptor struct {
	...
	LaunchStage         LaunchStage            `json:"x-databricks-launch-stage,omitempty"`
	EnumLaunchStages    map[string]LaunchStage `json:"x-databricks-enum-launch-stages,omitempty"`
