...
var EnumFields = map[string][]string{
	...
	"resources.app_spaces.*.permissions[*].level":                     {"CAN_ATTACH_TO", "CAN_BIND", "CAN_CREATE", "CAN_CREATE_APP", "CAN_EDIT", "CAN_EDIT_METADATA", "CAN_MANAGE", "CAN_MANAGE_PRODUCTION_VERSIONS", "CAN_MANAGE_RUN", "CAN_MANAGE_STAGING_VERSIONS", "CAN_MONITOR", "CAN_MONITOR_ONLY", "CAN_QUERY", "CAN_READ", "CAN_RESTART", "CAN_RUN", "CAN_USE", "CAN_VIEW", "CAN_VIEW_METADATA", "IS_OWNER"},
	"resources.app_spaces.*.resources[*].app.permission":              {"CAN_USE"},
	"resources.app_spaces.*.resources[*].database.permission":         {"CAN_CONNECT_AND_CREATE"},
	"resources.app_spaces.*.resources[*].experiment.permission":       {"CAN_EDIT", "CAN_MANAGE", "CAN_READ"},
	"resources.app_spaces.*.resources[*].genie_space.permission":      {"CAN_EDIT", "CAN_MANAGE", "CAN_RUN", "CAN_VIEW"},
	"resources.app_spaces.*.resources[*].job.permission":              {"CAN_MANAGE", "CAN_MANAGE_RUN", "CAN_VIEW", "IS_OWNER"},
	"resources.app_spaces.*.resources[*].postgres.permission":         {"CAN_CONNECT_AND_CREATE"},
	"resources.app_spaces.*.resources[*].secret.permission":           {"MANAGE", "READ", "WRITE"},
	"resources.app_spaces.*.resources[*].serving_endpoint.permission": {"CAN_MANAGE", "CAN_QUERY", "CAN_VIEW"},
	"resources.app_spaces.*.resources[*].sql_warehouse.permission":    {"CAN_MANAGE", "CAN_USE", "IS_OWNER"},
	"resources.app_spaces.*.resources[*].uc_securable.permission":     {"EXECUTE", "MODIFY", "READ_VOLUME", "SELECT", "USE_CONNECTION", "WRITE_VOLUME"},
	"resources.app_spaces.*.resources[*].uc_securable.securable_type": {"CONNECTION", "FUNCTION", "TABLE", "VOLUME"},
	"resources.app_spaces.*.status.state":                             {"SPACE_ACTIVE", "SPACE_CREATING", "SPACE_DELETED", "SPACE_DELETING", "SPACE_ERROR", "SPACE_UPDATING"},
