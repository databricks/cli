...
var EnumFields = map[string][]string{
	...
	"resources.job_runs.*.job_settings.continuous.pause_status":                                                          {"PAUSED", "UNPAUSED"},
	"resources.job_runs.*.job_settings.continuous.task_retry_mode":                                                       {"NEVER", "ON_FAILURE"},
	"resources.job_runs.*.job_settings.deployment.kind":                                                                  {"BUNDLE", "SYSTEM_MANAGED"},
	"resources.job_runs.*.job_settings.edit_mode":                                                                        {"EDITABLE", "UI_LOCKED"},
	"resources.job_runs.*.job_settings.format":                                                                           {"MULTI_TASK", "SINGLE_TASK"},
	"resources.job_runs.*.job_settings.git_source.git_provider":                                                          {"awsCodeCommit", "azureDevOpsServices", "bitbucketCloud", "bitbucketServer", "gitHub", "gitHubEnterprise", "gitLab", "gitLabEnterpriseEdition"},
	"resources.job_runs.*.job_settings.git_source.job_source.dirty_state":                                                {"DISCONNECTED", "NOT_SYNCED"},
	"resources.job_runs.*.job_settings.health.rules[*].metric":                                                           {"RUN_DURATION_SECONDS", "STREAMING_BACKLOG_BYTES", "STREAMING_BACKLOG_FILES", "STREAMING_BACKLOG_RECORDS", "STREAMING_BACKLOG_SECONDS"},
	"resources.job_runs.*.job_settings.health.rules[*].op":                                                               {"GREATER_THAN"},
	"resources.job_runs.*.job_settings.job_clusters[*].new_cluster.aws_attributes.availability":                          {"ON_DEMAND", "SPOT", "SPOT_WITH_FALLBACK"},
	"resources.job_runs.*.job_settings.job_clusters[*].new_cluster.aws_attributes.ebs_volume_type":                       {"GENERAL_PURPOSE_SSD", "THROUGHPUT_OPTIMIZED_HDD"},
	"resources.job_runs.*.job_settings.job_clusters[*].new_cluster.azure_attributes.availability":                        {"ON_DEMAND_AZURE", "SPOT_AZURE", "SPOT_WITH_FALLBACK_AZURE"},
	"resources.job_runs.*.job_settings.job_clusters[*].new_cluster.data_security_mode":                                   {"DATA_SECURITY_MODE_AUTO", "DATA_SECURITY_MODE_DEDICATED", "DATA_SECURITY_MODE_STANDARD", "LEGACY_PASSTHROUGH", "LEGACY_SINGLE_USER", "LEGACY_SINGLE_USER_STANDARD", "LEGACY_TABLE_ACL", "NONE", "SINGLE_USER", "USER_ISOLATION"},
	"resources.job_runs.*.job_settings.job_clusters[*].new_cluster.gcp_attributes.availability":                          {"ON_DEMAND_GCP", "PREEMPTIBLE_GCP", "PREEMPTIBLE_WITH_FALLBACK_GCP"},
	"resources.job_runs.*.job_settings.job_clusters[*].new_cluster.gcp_attributes.confidential_compute_type":             {"CONFIDENTIAL_COMPUTE_TYPE_NONE", "SEV_SNP"},
	"resources.job_runs.*.job_settings.job_clusters[*].new_cluster.kind":                                                 {"CLASSIC_PREVIEW"},
	"resources.job_runs.*.job_settings.job_clusters[*].new_cluster.runtime_engine":                                       {"NULL", "PHOTON", "STANDARD"},
	"resources.job_runs.*.job_settings.performance_target":                                                               {"PERFORMANCE_OPTIMIZED", "STANDARD"},
	"resources.job_runs.*.job_settings.schedule.pause_status":                                                            {"PAUSED", "UNPAUSED"},
	"resources.job_runs.*.job_settings.tasks[*].compute.hardware_accelerator":                                            {"GPU_1xA10", "GPU_8xH100"},
	"resources.job_runs.*.job_settings.tasks[*].condition_task.op":                                                       {"EQUAL_TO", "GREATER_THAN", "GREATER_THAN_OR_EQUAL", "LESS_THAN", "LESS_THAN_OR_EQUAL", "NOT_EQUAL"},
	"resources.job_runs.*.job_settings.tasks[*].dbt_task.source":                                                         {"GIT", "WORKSPACE"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.compute.hardware_accelerator":                         {"GPU_1xA10", "GPU_8xH100"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.condition_task.op":                                    {"EQUAL_TO", "GREATER_THAN", "GREATER_THAN_OR_EQUAL", "LESS_THAN", "LESS_THAN_OR_EQUAL", "NOT_EQUAL"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.dbt_task.source":                                      {"GIT", "WORKSPACE"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.gen_ai_compute_task.source":                           {"GIT", "WORKSPACE"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.health.rules[*].metric":                               {"RUN_DURATION_SECONDS", "STREAMING_BACKLOG_BYTES", "STREAMING_BACKLOG_FILES", "STREAMING_BACKLOG_RECORDS", "STREAMING_BACKLOG_SECONDS"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.health.rules[*].op":                                   {"GREATER_THAN"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.new_cluster.aws_attributes.availability":              {"ON_DEMAND", "SPOT", "SPOT_WITH_FALLBACK"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.new_cluster.aws_attributes.ebs_volume_type":           {"GENERAL_PURPOSE_SSD", "THROUGHPUT_OPTIMIZED_HDD"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.new_cluster.azure_attributes.availability":            {"ON_DEMAND_AZURE", "SPOT_AZURE", "SPOT_WITH_FALLBACK_AZURE"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.new_cluster.data_security_mode":                       {"DATA_SECURITY_MODE_AUTO", "DATA_SECURITY_MODE_DEDICATED", "DATA_SECURITY_MODE_STANDARD", "LEGACY_PASSTHROUGH", "LEGACY_SINGLE_USER", "LEGACY_SINGLE_USER_STANDARD", "LEGACY_TABLE_ACL", "NONE", "SINGLE_USER", "USER_ISOLATION"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.new_cluster.gcp_attributes.availability":              {"ON_DEMAND_GCP", "PREEMPTIBLE_GCP", "PREEMPTIBLE_WITH_FALLBACK_GCP"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.new_cluster.gcp_attributes.confidential_compute_type": {"CONFIDENTIAL_COMPUTE_TYPE_NONE", "SEV_SNP"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.new_cluster.kind":                                     {"CLASSIC_PREVIEW"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.new_cluster.runtime_engine":                           {"NULL", "PHOTON", "STANDARD"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.notebook_task.source":                                 {"GIT", "WORKSPACE"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.power_bi_task.power_bi_model.authentication_method":   {"OAUTH", "PAT"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.power_bi_task.power_bi_model.storage_mode":            {"DIRECT_QUERY", "DUAL", "IMPORT"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.power_bi_task.tables[*].storage_mode":                 {"DIRECT_QUERY", "DUAL", "IMPORT"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.run_if":                                               {"ALL_DONE", "ALL_FAILED", "ALL_SUCCESS", "AT_LEAST_ONE_FAILED", "AT_LEAST_ONE_SUCCESS", "NONE_FAILED"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.spark_python_task.source":                             {"GIT", "WORKSPACE"},
	"resources.job_runs.*.job_settings.tasks[*].for_each_task.task.sql_task.file.source":                                 {"GIT", "WORKSPACE"},
	"resources.job_runs.*.job_settings.tasks[*].gen_ai_compute_task.source":                                              {"GIT", "WORKSPACE"},
	"resources.job_runs.*.job_settings.tasks[*].health.rules[*].metric":                                                  {"RUN_DURATION_SECONDS", "STREAMING_BACKLOG_BYTES", "STREAMING_BACKLOG_FILES", "STREAMING_BACKLOG_RECORDS", "STREAMING_BACKLOG_SECONDS"},
	"resources.job_runs.*.job_settings.tasks[*].health.rules[*].op":                                                      {"GREATER_THAN"},
	"resources.job_runs.*.job_settings.tasks[*].new_cluster.aws_attributes.availability":                                 {"ON_DEMAND", "SPOT", "SPOT_WITH_FALLBACK"},
	"resources.job_runs.*.job_settings.tasks[*].new_cluster.aws_attributes.ebs_volume_type":                              {"GENERAL_PURPOSE_SSD", "THROUGHPUT_OPTIMIZED_HDD"},
	"resources.job_runs.*.job_settings.tasks[*].new_cluster.azure_attributes.availability":                               {"ON_DEMAND_AZURE", "SPOT_AZURE", "SPOT_WITH_FALLBACK_AZURE"},
	"resources.job_runs.*.job_settings.tasks[*].new_cluster.data_security_mode":                                          {"DATA_SECURITY_MODE_AUTO", "DATA_SECURITY_MODE_DEDICATED", "DATA_SECURITY_MODE_STANDARD", "LEGACY_PASSTHROUGH", "LEGACY_SINGLE_USER", "LEGACY_SINGLE_USER_STANDARD", "LEGACY_TABLE_ACL", "NONE", "SINGLE_USER", "USER_ISOLATION"},
	"resources.job_runs.*.job_settings.tasks[*].new_cluster.gcp_attributes.availability":                                 {"ON_DEMAND_GCP", "PREEMPTIBLE_GCP", "PREEMPTIBLE_WITH_FALLBACK_GCP"},
	"resources.job_runs.*.job_settings.tasks[*].new_cluster.gcp_attributes.confidential_compute_type":                    {"CONFIDENTIAL_COMPUTE_TYPE_NONE", "SEV_SNP"},
	"resources.job_runs.*.job_settings.tasks[*].new_cluster.kind":                                                        {"CLASSIC_PREVIEW"},
	"resources.job_runs.*.job_settings.tasks[*].new_cluster.runtime_engine":                                              {"NULL", "PHOTON", "STANDARD"},
	"resources.job_runs.*.job_settings.tasks[*].notebook_task.source":                                                    {"GIT", "WORKSPACE"},
	"resources.job_runs.*.job_settings.tasks[*].power_bi_task.power_bi_model.authentication_method":                      {"OAUTH", "PAT"},
	"resources.job_runs.*.job_settings.tasks[*].power_bi_task.power_bi_model.storage_mode":                               {"DIRECT_QUERY", "DUAL", "IMPORT"},
	"resources.job_runs.*.job_settings.tasks[*].power_bi_task.tables[*].storage_mode":                                    {"DIRECT_QUERY", "DUAL", "IMPORT"},
	"resources.job_runs.*.job_settings.tasks[*].run_if":                                                                  {"ALL_DONE", "ALL_FAILED", "ALL_SUCCESS", "AT_LEAST_ONE_FAILED", "AT_LEAST_ONE_SUCCESS", "NONE_FAILED"},
	"resources.job_runs.*.job_settings.tasks[*].spark_python_task.source":                                                {"GIT", "WORKSPACE"},
	"resources.job_runs.*.job_settings.tasks[*].sql_task.file.source":                                                    {"GIT", "WORKSPACE"},
	"resources.job_runs.*.job_settings.trigger.model.condition":                                                          {"MODEL_ALIAS_SET", "MODEL_CREATED", "MODEL_VERSION_READY"},
	"resources.job_runs.*.job_settings.trigger.pause_status":                                                             {"PAUSED", "UNPAUSED"},
	"resources.job_runs.*.job_settings.trigger.periodic.unit":                                                            {"DAYS", "HOURS", "WEEKS"},
	"resources.job_runs.*.job_settings.trigger.table_update.condition":                                                   {"ALL_UPDATED", "ANY_UPDATED"},
	...
	"resources.model_serving_endpoints.*.config.served_entities[*].workload_type":                                         {"CPU", "GPU_LARGE", "GPU_MEDIUM", "GPU_SMALL", "GPU_XLARGE", "MULTIGPU_MEDIUM"},
	"resources.model_serving_endpoints.*.config.served_models[*].workload_type":                                           {"CPU", "GPU_LARGE", "GPU_MEDIUM", "GPU_SMALL", "GPU_XLARGE", "MULTIGPU_MEDIUM"},
