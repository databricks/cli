...
var EnumFields = map[string][]string{
	...
	"resources.clusters.*.dependency_mode":                          {"DEPENDENCY_MODE_AUTO", "DEPENDENCY_MODE_CLUSTER_LIBRARIES", "DEPENDENCY_MODE_ENVIRONMENTS"},
	...
	"resources.jobs.*.job_clusters[*].new_cluster.dependency_mode":                                         {"DEPENDENCY_MODE_AUTO", "DEPENDENCY_MODE_CLUSTER_LIBRARIES", "DEPENDENCY_MODE_ENVIRONMENTS"},
	...
	"resources.jobs.*.tasks[*].ai_runtime_task.deployments[*].compute.accelerator_type":                    {"GPU_1xA10", "GPU_1xH100", "GPU_8xB300", "GPU_8xH100"},
	"resources.jobs.*.tasks[*].ai_runtime_task.priority_class":                                             {"BEST_EFFORT", "CRITICAL", "NORMAL"},
	"resources.jobs.*.tasks[*].compute.hardware_accelerator":                                               {"GPU_1xA10", "GPU_1xH100", "GPU_8xB300", "GPU_8xH100"},
	...
	"resources.jobs.*.tasks[*].for_each_task.task.ai_runtime_task.deployments[*].compute.accelerator_type": {"GPU_1xA10", "GPU_1xH100", "GPU_8xB300", "GPU_8xH100"},
	"resources.jobs.*.tasks[*].for_each_task.task.ai_runtime_task.priority_class":                          {"BEST_EFFORT", "CRITICAL", "NORMAL"},
	"resources.jobs.*.tasks[*].for_each_task.task.compute.hardware_accelerator":                            {"GPU_1xA10", "GPU_1xH100", "GPU_8xB300", "GPU_8xH100"},
	...
	"resources.jobs.*.tasks[*].for_each_task.task.new_cluster.dependency_mode":                             {"DEPENDENCY_MODE_AUTO", "DEPENDENCY_MODE_CLUSTER_LIBRARIES", "DEPENDENCY_MODE_ENVIRONMENTS"},
	...
	"resources.jobs.*.tasks[*].new_cluster.dependency_mode":                                                {"DEPENDENCY_MODE_AUTO", "DEPENDENCY_MODE_CLUSTER_LIBRARIES", "DEPENDENCY_MODE_ENVIRONMENTS"},
	...
	"resources.mcp_services.*.config.rate_limits[*].key":            {"RATE_LIMIT_KEY_SERVICE", "RATE_LIMIT_KEY_SERVICE_PRINCIPAL", "RATE_LIMIT_KEY_USER", "RATE_LIMIT_KEY_USER_DEFAULT", "RATE_LIMIT_KEY_USER_GROUP"},
	...
	"resources.model_provider_services.*.config.rate_limits[*].key":            {"RATE_LIMIT_KEY_SERVICE", "RATE_LIMIT_KEY_SERVICE_PRINCIPAL", "RATE_LIMIT_KEY_USER", "RATE_LIMIT_KEY_USER_DEFAULT", "RATE_LIMIT_KEY_USER_GROUP"},
	...
	"resources.model_services.*.config.rate_limits[*].key":                                {"RATE_LIMIT_KEY_SERVICE", "RATE_LIMIT_KEY_SERVICE_PRINCIPAL", "RATE_LIMIT_KEY_USER", "RATE_LIMIT_KEY_USER_DEFAULT", "RATE_LIMIT_KEY_USER_GROUP"},
	...
	"resources.pipelines.*.ingestion_definition.objects[*].schema.connector_options.kafka_options.key_transformer.avro_options.parse_mode":              {"FAILFAST", "PERMISSIVE"},
	"resources.pipelines.*.ingestion_definition.objects[*].schema.connector_options.kafka_options.key_transformer.format":                               {"AVRO", "JSON", "PROTOBUF", "STRING"},
	...
	"resources.pipelines.*.ingestion_definition.objects[*].schema.connector_options.kafka_options.key_transformer.protobuf_options.parse_mode":          {"FAILFAST", "PERMISSIVE"},
	"resources.pipelines.*.ingestion_definition.objects[*].schema.connector_options.kafka_options.value_transformer.avro_options.parse_mode":            {"FAILFAST", "PERMISSIVE"},
	"resources.pipelines.*.ingestion_definition.objects[*].schema.connector_options.kafka_options.value_transformer.format":                             {"AVRO", "JSON", "PROTOBUF", "STRING"},
	...
	"resources.pipelines.*.ingestion_definition.objects[*].schema.connector_options.kafka_options.value_transformer.protobuf_options.parse_mode":        {"FAILFAST", "PERMISSIVE"},
	...
	"resources.pipelines.*.ingestion_definition.objects[*].schema.fanout_options.transforms[*].avro_options.parse_mode":                                 {"FAILFAST", "PERMISSIVE"},
	"resources.pipelines.*.ingestion_definition.objects[*].schema.fanout_options.transforms[*].format":                                                  {"AVRO", "JSON", "PROTOBUF", "STRING"},
	"resources.pipelines.*.ingestion_definition.objects[*].schema.fanout_options.transforms[*].json_options.schema_evolution_mode":                      {"ADD_NEW_COLUMNS", "ADD_NEW_COLUMNS_WITH_TYPE_WIDENING", "FAIL_ON_NEW_COLUMNS", "NONE", "RESCUE"},
	"resources.pipelines.*.ingestion_definition.objects[*].schema.fanout_options.transforms[*].protobuf_options.parse_mode":                             {"FAILFAST", "PERMISSIVE"},
	...
	"resources.pipelines.*.ingestion_definition.objects[*].table.connector_options.kafka_options.key_transformer.avro_options.parse_mode":               {"FAILFAST", "PERMISSIVE"},
	"resources.pipelines.*.ingestion_definition.objects[*].table.connector_options.kafka_options.key_transformer.format":                                {"AVRO", "JSON", "PROTOBUF", "STRING"},
	...
	"resources.pipelines.*.ingestion_definition.objects[*].table.connector_options.kafka_options.key_transformer.protobuf_options.parse_mode":           {"FAILFAST", "PERMISSIVE"},
	"resources.pipelines.*.ingestion_definition.objects[*].table.connector_options.kafka_options.value_transformer.avro_options.parse_mode":             {"FAILFAST", "PERMISSIVE"},
	"resources.pipelines.*.ingestion_definition.objects[*].table.connector_options.kafka_options.value_transformer.format":                              {"AVRO", "JSON", "PROTOBUF", "STRING"},
	...
	"resources.pipelines.*.ingestion_definition.objects[*].table.connector_options.kafka_options.value_transformer.protobuf_options.parse_mode":         {"FAILFAST", "PERMISSIVE"},
	...
	"resources.vector_search_endpoints.*.permissions[*].level": {"CAN_CREATE", "CAN_MANAGE", "CAN_USE"},
