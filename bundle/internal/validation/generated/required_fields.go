...
var RequiredFields = map[string][]string{
	...
	"environments.*.artifacts.*.files[*]": {"source"},
	"environments.*.bundle": {"name"},
	"environments.*.permissions[*]": {"level"},
	"environments.*.resources.apps.*": {"source_code_path", "name"},
	"environments.*.resources.apps.*.permissions[*]": {"level"},
	"environments.*.resources.apps.*.resources[*]": {"name"},
	"environments.*.resources.apps.*.resources[*].job": {"id", "permission"},
	"environments.*.resources.apps.*.resources[*].secret": {"key", "permission", "scope"},
	"environments.*.resources.apps.*.resources[*].serving_endpoint": {"name", "permission"},
	"environments.*.resources.apps.*.resources[*].sql_warehouse": {"id", "permission"},
	"environments.*.resources.apps.*.resources[*].uc_securable": {"permission", "securable_full_name", "securable_type"},
	"environments.*.resources.clusters.*.cluster_log_conf.dbfs": {"destination"},
	"environments.*.resources.clusters.*.cluster_log_conf.s3": {"destination"},
	"environments.*.resources.clusters.*.cluster_log_conf.volumes": {"destination"},
	"environments.*.resources.clusters.*.init_scripts[*].abfss": {"destination"},
	"environments.*.resources.clusters.*.init_scripts[*].dbfs": {"destination"},
	"environments.*.resources.clusters.*.init_scripts[*].file": {"destination"},
	"environments.*.resources.clusters.*.init_scripts[*].gcs": {"destination"},
	"environments.*.resources.clusters.*.init_scripts[*].s3": {"destination"},
	"environments.*.resources.clusters.*.init_scripts[*].volumes": {"destination"},
	"environments.*.resources.clusters.*.init_scripts[*].workspace": {"destination"},
	"environments.*.resources.clusters.*.permissions[*]": {"level"},
	"environments.*.resources.clusters.*.workload_type": {"clients"},
	"environments.*.resources.dashboards.*.permissions[*]": {"level"},
	"environments.*.resources.experiments.*.permissions[*]": {"level"},
	"environments.*.resources.jobs.*.deployment": {"kind"},
	"environments.*.resources.jobs.*.environments[*]": {"environment_key"},
	"environments.*.resources.jobs.*.environments[*].spec": {"client"},
	"environments.*.resources.jobs.*.git_source": {"git_provider", "git_url"},
	"environments.*.resources.jobs.*.git_source.job_source": {"import_from_git_branch", "job_config_path"},
	"environments.*.resources.jobs.*.health.rules[*]": {"metric", "op", "value"},
	"environments.*.resources.jobs.*.job_clusters[*]": {"job_cluster_key", "new_cluster"},
	"environments.*.resources.jobs.*.job_clusters[*].new_cluster.cluster_log_conf.dbfs": {"destination"},
	"environments.*.resources.jobs.*.job_clusters[*].new_cluster.cluster_log_conf.s3": {"destination"},
	"environments.*.resources.jobs.*.job_clusters[*].new_cluster.cluster_log_conf.volumes": {"destination"},
	"environments.*.resources.jobs.*.job_clusters[*].new_cluster.init_scripts[*].abfss": {"destination"},
	"environments.*.resources.jobs.*.job_clusters[*].new_cluster.init_scripts[*].dbfs": {"destination"},
	"environments.*.resources.jobs.*.job_clusters[*].new_cluster.init_scripts[*].file": {"destination"},
	"environments.*.resources.jobs.*.job_clusters[*].new_cluster.init_scripts[*].gcs": {"destination"},
	"environments.*.resources.jobs.*.job_clusters[*].new_cluster.init_scripts[*].s3": {"destination"},
	"environments.*.resources.jobs.*.job_clusters[*].new_cluster.init_scripts[*].volumes": {"destination"},
	"environments.*.resources.jobs.*.job_clusters[*].new_cluster.init_scripts[*].workspace": {"destination"},
	"environments.*.resources.jobs.*.job_clusters[*].new_cluster.workload_type": {"clients"},
	"environments.*.resources.jobs.*.parameters[*]": {"default", "name"},
	"environments.*.resources.jobs.*.permissions[*]": {"level"},
	"environments.*.resources.jobs.*.queue": {"enabled"},
	"environments.*.resources.jobs.*.schedule": {"quartz_cron_expression", "timezone_id"},
	"environments.*.resources.jobs.*.tasks[*]": {"task_key"},
	"environments.*.resources.jobs.*.tasks[*].clean_rooms_notebook_task": {"clean_room_name", "notebook_name"},
	"environments.*.resources.jobs.*.tasks[*].condition_task": {"left", "op", "right"},
	"environments.*.resources.jobs.*.tasks[*].dbt_task": {"commands"},
	"environments.*.resources.jobs.*.tasks[*].depends_on[*]": {"task_key"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task": {"inputs", "task"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task": {"task_key"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.clean_rooms_notebook_task": {"clean_room_name", "notebook_name"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.condition_task": {"left", "op", "right"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.dbt_task": {"commands"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.depends_on[*]": {"task_key"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.for_each_task": {"inputs", "task"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.gen_ai_compute_task": {"dl_runtime_image"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.gen_ai_compute_task.compute": {"num_gpus"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.health.rules[*]": {"metric", "op", "value"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.libraries[*].cran": {"package"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.libraries[*].maven": {"coordinates"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.libraries[*].pypi": {"package"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.cluster_log_conf.dbfs": {"destination"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.cluster_log_conf.s3": {"destination"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.cluster_log_conf.volumes": {"destination"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.init_scripts[*].abfss": {"destination"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.init_scripts[*].dbfs": {"destination"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.init_scripts[*].file": {"destination"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.init_scripts[*].gcs": {"destination"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.init_scripts[*].s3": {"destination"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.init_scripts[*].volumes": {"destination"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.init_scripts[*].workspace": {"destination"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.workload_type": {"clients"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.notebook_task": {"notebook_path"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.pipeline_task": {"pipeline_id"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.python_wheel_task": {"entry_point", "package_name"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.run_job_task": {"job_id"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.spark_python_task": {"python_file"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.sql_task": {"warehouse_id"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.sql_task.alert": {"alert_id"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.sql_task.dashboard": {"dashboard_id"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.sql_task.file": {"path"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.sql_task.query": {"query_id"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.webhook_notifications.on_duration_warning_threshold_exceeded[*]": {"id"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.webhook_notifications.on_failure[*]": {"id"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.webhook_notifications.on_start[*]": {"id"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.webhook_notifications.on_streaming_backlog_exceeded[*]": {"id"},
	"environments.*.resources.jobs.*.tasks[*].for_each_task.task.webhook_notifications.on_success[*]": {"id"},
	"environments.*.resources.jobs.*.tasks[*].gen_ai_compute_task": {"dl_runtime_image"},
	"environments.*.resources.jobs.*.tasks[*].gen_ai_compute_task.compute": {"num_gpus"},
	"environments.*.resources.jobs.*.tasks[*].health.rules[*]": {"metric", "op", "value"},
	"environments.*.resources.jobs.*.tasks[*].libraries[*].cran": {"package"},
	"environments.*.resources.jobs.*.tasks[*].libraries[*].maven": {"coordinates"},
	"environments.*.resources.jobs.*.tasks[*].libraries[*].pypi": {"package"},
	"environments.*.resources.jobs.*.tasks[*].new_cluster.cluster_log_conf.dbfs": {"destination"},
	"environments.*.resources.jobs.*.tasks[*].new_cluster.cluster_log_conf.s3": {"destination"},
	"environments.*.resources.jobs.*.tasks[*].new_cluster.cluster_log_conf.volumes": {"destination"},
	"environments.*.resources.jobs.*.tasks[*].new_cluster.init_scripts[*].abfss": {"destination"},
	"environments.*.resources.jobs.*.tasks[*].new_cluster.init_scripts[*].dbfs": {"destination"},
	"environments.*.resources.jobs.*.tasks[*].new_cluster.init_scripts[*].file": {"destination"},
	"environments.*.resources.jobs.*.tasks[*].new_cluster.init_scripts[*].gcs": {"destination"},
	"environments.*.resources.jobs.*.tasks[*].new_cluster.init_scripts[*].s3": {"destination"},
	"environments.*.resources.jobs.*.tasks[*].new_cluster.init_scripts[*].volumes": {"destination"},
	"environments.*.resources.jobs.*.tasks[*].new_cluster.init_scripts[*].workspace": {"destination"},
	"environments.*.resources.jobs.*.tasks[*].new_cluster.workload_type": {"clients"},
	"environments.*.resources.jobs.*.tasks[*].notebook_task": {"notebook_path"},
	"environments.*.resources.jobs.*.tasks[*].pipeline_task": {"pipeline_id"},
	"environments.*.resources.jobs.*.tasks[*].python_wheel_task": {"entry_point", "package_name"},
	"environments.*.resources.jobs.*.tasks[*].run_job_task": {"job_id"},
	"environments.*.resources.jobs.*.tasks[*].spark_python_task": {"python_file"},
	"environments.*.resources.jobs.*.tasks[*].sql_task": {"warehouse_id"},
	"environments.*.resources.jobs.*.tasks[*].sql_task.alert": {"alert_id"},
	"environments.*.resources.jobs.*.tasks[*].sql_task.dashboard": {"dashboard_id"},
	"environments.*.resources.jobs.*.tasks[*].sql_task.file": {"path"},
	"environments.*.resources.jobs.*.tasks[*].sql_task.query": {"query_id"},
	"environments.*.resources.jobs.*.tasks[*].webhook_notifications.on_duration_warning_threshold_exceeded[*]": {"id"},
	"environments.*.resources.jobs.*.tasks[*].webhook_notifications.on_failure[*]": {"id"},
	"environments.*.resources.jobs.*.tasks[*].webhook_notifications.on_start[*]": {"id"},
	"environments.*.resources.jobs.*.tasks[*].webhook_notifications.on_streaming_backlog_exceeded[*]": {"id"},
	"environments.*.resources.jobs.*.tasks[*].webhook_notifications.on_success[*]": {"id"},
	"environments.*.resources.jobs.*.trigger.file_arrival": {"url"},
	"environments.*.resources.jobs.*.trigger.periodic": {"interval", "unit"},
	"environments.*.resources.jobs.*.webhook_notifications.on_duration_warning_threshold_exceeded[*]": {"id"},
	"environments.*.resources.jobs.*.webhook_notifications.on_failure[*]": {"id"},
	"environments.*.resources.jobs.*.webhook_notifications.on_start[*]": {"id"},
	"environments.*.resources.jobs.*.webhook_notifications.on_streaming_backlog_exceeded[*]": {"id"},
	"environments.*.resources.jobs.*.webhook_notifications.on_success[*]": {"id"},
	"environments.*.resources.model_serving_endpoints.*": {"name"},
	"environments.*.resources.model_serving_endpoints.*.ai_gateway.fallback_config": {"enabled"},
	"environments.*.resources.model_serving_endpoints.*.ai_gateway.rate_limits[*]": {"calls", "renewal_period"},
	"environments.*.resources.model_serving_endpoints.*.config.served_entities[*].external_model": {"name", "provider", "task"},
	"environments.*.resources.model_serving_endpoints.*.config.served_entities[*].external_model.amazon_bedrock_config": {"aws_region", "bedrock_provider"},
	"environments.*.resources.model_serving_endpoints.*.config.served_entities[*].external_model.custom_provider_config": {"custom_provider_url"},
	"environments.*.resources.model_serving_endpoints.*.config.served_entities[*].external_model.custom_provider_config.api_key_auth": {"key"},
	"environments.*.resources.model_serving_endpoints.*.config.served_entities[*].external_model.databricks_model_serving_config": {"databricks_workspace_url"},
	"environments.*.resources.model_serving_endpoints.*.config.served_entities[*].external_model.google_cloud_vertex_ai_config": {"project_id", "region"},
	"environments.*.resources.model_serving_endpoints.*.config.served_models[*]": {"model_name", "model_version", "scale_to_zero_enabled"},
	"environments.*.resources.model_serving_endpoints.*.config.traffic_config.routes[*]": {"served_model_name", "traffic_percentage"},
	"environments.*.resources.model_serving_endpoints.*.permissions[*]": {"level"},
	"environments.*.resources.model_serving_endpoints.*.rate_limits[*]": {"calls", "renewal_period"},
	"environments.*.resources.model_serving_endpoints.*.tags[*]": {"key"},
	"environments.*.resources.models.*": {"name"},
	"environments.*.resources.models.*.permissions[*]": {"level"},
	"environments.*.resources.pipelines.*.clusters[*].autoscale": {"max_workers", "min_workers"},
	"environments.*.resources.pipelines.*.clusters[*].cluster_log_conf.dbfs": {"destination"},
	"environments.*.resources.pipelines.*.clusters[*].cluster_log_conf.s3": {"destination"},
	"environments.*.resources.pipelines.*.clusters[*].cluster_log_conf.volumes": {"destination"},
	"environments.*.resources.pipelines.*.clusters[*].init_scripts[*].abfss": {"destination"},
	"environments.*.resources.pipelines.*.clusters[*].init_scripts[*].dbfs": {"destination"},
	"environments.*.resources.pipelines.*.clusters[*].init_scripts[*].file": {"destination"},
	"environments.*.resources.pipelines.*.clusters[*].init_scripts[*].gcs": {"destination"},
	"environments.*.resources.pipelines.*.clusters[*].init_scripts[*].s3": {"destination"},
	"environments.*.resources.pipelines.*.clusters[*].init_scripts[*].volumes": {"destination"},
	"environments.*.resources.pipelines.*.clusters[*].init_scripts[*].workspace": {"destination"},
	"environments.*.resources.pipelines.*.deployment": {"kind"},
	"environments.*.resources.pipelines.*.gateway_definition": {"connection_name", "gateway_storage_catalog", "gateway_storage_schema"},
	"environments.*.resources.pipelines.*.ingestion_definition.objects[*].report": {"destination_catalog", "destination_schema", "source_url"},
	"environments.*.resources.pipelines.*.ingestion_definition.objects[*].schema": {"destination_catalog", "destination_schema", "source_schema"},
	"environments.*.resources.pipelines.*.ingestion_definition.objects[*].table": {"destination_catalog", "destination_schema", "source_table"},
	"environments.*.resources.pipelines.*.libraries[*].maven": {"coordinates"},
	"environments.*.resources.pipelines.*.permissions[*]": {"level"},
	"environments.*.resources.pipelines.*.restart_window": {"start_hour"},
	"environments.*.resources.quality_monitors.*": {"table_name", "assets_dir", "output_schema_name"},
	"environments.*.resources.quality_monitors.*.custom_metrics[*]": {"definition", "input_columns", "name", "output_data_type", "type"},
	"environments.*.resources.quality_monitors.*.inference_log": {"granularities", "model_id_col", "prediction_col", "problem_type", "timestamp_col"},
	"environments.*.resources.quality_monitors.*.schedule": {"quartz_cron_expression", "timezone_id"},
	"environments.*.resources.quality_monitors.*.time_series": {"granularities", "timestamp_col"},
	"environments.*.resources.registered_models.*": {"catalog_name", "name", "schema_name"},
	"environments.*.resources.registered_models.*.grants[*]": {"privileges", "principal"},
	"environments.*.resources.schemas.*": {"catalog_name", "name"},
	"environments.*.resources.schemas.*.grants[*]": {"privileges", "principal"},
	"environments.*.resources.secret_scopes.*": {"name"},
	"environments.*.resources.secret_scopes.*.keyvault_metadata": {"dns_name", "resource_id"},
	"environments.*.resources.secret_scopes.*.permissions[*]": {"level"},
	"environments.*.resources.volumes.*": {"catalog_name", "name", "schema_name", "volume_type"},
	"environments.*.resources.volumes.*.grants[*]": {"privileges", "principal"},
	...
	"targets.*.resources.jobs.*.deployment": {"kind"},
	...
	"targets.*.resources.jobs.*.git_source.job_source": {"import_from_git_branch", "job_config_path"},
	...
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task": {"task_key"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.clean_rooms_notebook_task": {"clean_room_name", "notebook_name"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.condition_task": {"left", "op", "right"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.dbt_task": {"commands"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.depends_on[*]": {"task_key"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.for_each_task": {"inputs", "task"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.gen_ai_compute_task": {"dl_runtime_image"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.gen_ai_compute_task.compute": {"num_gpus"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.health.rules[*]": {"metric", "op", "value"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.libraries[*].cran": {"package"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.libraries[*].maven": {"coordinates"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.libraries[*].pypi": {"package"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.cluster_log_conf.dbfs": {"destination"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.cluster_log_conf.s3": {"destination"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.cluster_log_conf.volumes": {"destination"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.init_scripts[*].abfss": {"destination"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.init_scripts[*].dbfs": {"destination"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.init_scripts[*].file": {"destination"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.init_scripts[*].gcs": {"destination"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.init_scripts[*].s3": {"destination"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.init_scripts[*].volumes": {"destination"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.init_scripts[*].workspace": {"destination"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.new_cluster.workload_type": {"clients"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.notebook_task": {"notebook_path"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.pipeline_task": {"pipeline_id"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.python_wheel_task": {"entry_point", "package_name"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.run_job_task": {"job_id"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.spark_python_task": {"python_file"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.sql_task": {"warehouse_id"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.sql_task.alert": {"alert_id"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.sql_task.dashboard": {"dashboard_id"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.sql_task.file": {"path"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.sql_task.query": {"query_id"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.webhook_notifications.on_duration_warning_threshold_exceeded[*]": {"id"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.webhook_notifications.on_failure[*]": {"id"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.webhook_notifications.on_start[*]": {"id"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.webhook_notifications.on_streaming_backlog_exceeded[*]": {"id"},
	"targets.*.resources.jobs.*.tasks[*].for_each_task.task.webhook_notifications.on_success[*]": {"id"},
	...
	"targets.*.resources.pipelines.*.deployment": {"kind"},
	...
	"targets.*.resources.volumes.*": {"catalog_name", "name", "schema_name", "volume_type"},
