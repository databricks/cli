...
var RequiredFields = map[string][]string{
	...
	"resources.apps.*.default_git_source.git_repository":              {"provider", "url"},
	...
	"resources.experiments.*.trace_location.uc_trace_location": {"catalog", "schema"},
	...
	"resources.jobs.*.continuous.maintenance_window":                                                               {"day_of_week", "start_hour", "timezone_id"},
	...
	"resources.jobs.*.triggers[*].continuous.maintenance_window":                                                   {"day_of_week", "start_hour", "timezone_id"},
	"resources.jobs.*.triggers[*].file_arrival":                                                                    {"url"},
	"resources.jobs.*.triggers[*].model":                                                                           {"condition"},
	"resources.jobs.*.triggers[*].periodic":                                                                        {"interval", "unit"},
	"resources.jobs.*.triggers[*].schedule":                                                                        {"quartz_cron_expression", "timezone_id"},
	"resources.jobs.*.triggers[*].sql_condition":                                                                   {"sql_query_id", "warehouse_id"},
	"resources.jobs.*.triggers[*].table_update":                                                                    {"table_names"},
	...
	"resources.model_services.*.config.routing.destinations[*]":                                        {"destination_type", "name"},
	"resources.model_services.*.config.routing.destinations[*].external_model_config":                  {"model_provider_service", "target"},
	"resources.model_services.*.config.routing.destinations[*].external_model_config.target":           {"model"},
	"resources.model_services.*.config.routing.destinations[*].pay_per_token_config":                   {"model"},
	"resources.model_services.*.config.routing.destinations[*].provisioned_throughput_config":          {"model_serving_endpoint"},
	"resources.model_services.*.config.routing.fallback.destinations[*]":                               {"destination_type", "name"},
	"resources.model_services.*.config.routing.fallback.destinations[*].external_model_config":         {"model_provider_service", "target"},
	"resources.model_services.*.config.routing.fallback.destinations[*].external_model_config.target":  {"model"},
	"resources.model_services.*.config.routing.fallback.destinations[*].pay_per_token_config":          {"model"},
	"resources.model_services.*.config.routing.fallback.destinations[*].provisioned_throughput_config": {"model_serving_endpoint"},
	...
	"resources.pipelines.*.ingestion_definition.objects[*].schema":                                                              {"destination_catalog", "destination_schema"},
	"resources.pipelines.*.ingestion_definition.objects[*].schema.connector_options.google_ads_options":                         {"manager_account_id"},
	"resources.pipelines.*.ingestion_definition.objects[*].schema.connector_options.google_ads_options.custom_report_options":   {"resource"},
	"resources.pipelines.*.ingestion_definition.objects[*].schema.connector_options.linkedin_ads_options.custom_report_options": {"finder"},
	"resources.pipelines.*.ingestion_definition.objects[*].schema.connector_options.rabbitmq_options":                           {"queue"},
	"resources.pipelines.*.ingestion_definition.objects[*].schema.table_configuration.auto_full_refresh_policy":                 {"enabled"},
	"resources.pipelines.*.ingestion_definition.objects[*].table":                                                               {"destination_catalog", "destination_schema"},
	"resources.pipelines.*.ingestion_definition.objects[*].table.connector_options.google_ads_options":                          {"manager_account_id"},
	"resources.pipelines.*.ingestion_definition.objects[*].table.connector_options.google_ads_options.custom_report_options":    {"resource"},
	"resources.pipelines.*.ingestion_definition.objects[*].table.connector_options.linkedin_ads_options.custom_report_options":  {"finder"},
	"resources.pipelines.*.ingestion_definition.objects[*].table.connector_options.rabbitmq_options":                            {"queue"},
	...
	"resources.postgres_databases.*": {"role", "database_id", "parent"},
