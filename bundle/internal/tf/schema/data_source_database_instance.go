...
type DataSourceDatabaseInstanceCustomTags struct {
	Key   string `json:"key,omitempty"`
	Value string `json:"value,omitempty"`
}

type DataSourceDatabaseInstanceEffectiveCustomTags struct {
	Key   string `json:"key,omitempty"`
	Value string `json:"value,omitempty"`
}
...
type DataSourceDatabaseInstance struct {
	...
	CustomTags                         []DataSourceDatabaseInstanceCustomTags          `json:"custom_tags,omitempty"`
	EffectiveCapacity                  string                                          `json:"effective_capacity,omitempty"`
	EffectiveCustomTags                []DataSourceDatabaseInstanceEffectiveCustomTags `json:"effective_custom_tags,omitempty"`
