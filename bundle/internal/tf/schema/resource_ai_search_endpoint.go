...
type ResourceAiSearchEndpointCustomTags struct {
	Key   string `json:"key"`
	Value string `json:"value,omitempty"`
}

type ResourceAiSearchEndpointEndpointStatus struct {
	Message string `json:"message,omitempty"`
	State   string `json:"state,omitempty"`
}

type ResourceAiSearchEndpointProviderConfig struct {
	WorkspaceId string `json:"workspace_id,omitempty"`
}

type ResourceAiSearchEndpointScalingInfo struct {
	RequestedTargetQps int    `json:"requested_target_qps,omitempty"`
	State              string `json:"state,omitempty"`
}

type ResourceAiSearchEndpointThroughputInfo struct {
...
type ResourceAiSearchEndpoint struct {
	BudgetPolicyId          string                                  `json:"budget_policy_id,omitempty"`
	CreateTime              string                                  `json:"create_time,omitempty"`
	Creator                 string                                  `json:"creator,omitempty"`
	CustomTags              []ResourceAiSearchEndpointCustomTags    `json:"custom_tags,omitempty"`
	EffectiveBudgetPolicyId string                                  `json:"effective_budget_policy_id,omitempty"`
	EndpointId              string                                  `json:"endpoint_id,omitempty"`
	EndpointStatus          *ResourceAiSearchEndpointEndpointStatus `json:"endpoint_status,omitempty"`
	...
	ProviderConfig          *ResourceAiSearchEndpointProviderConfig `json:"provider_config,omitempty"`
	ReplicaCount            int                                     `json:"replica_count,omitempty"`
	ScalingInfo             *ResourceAiSearchEndpointScalingInfo    `json:"scaling_info,omitempty"`
	TargetQps               int                                     `json:"target_qps,omitempty"`
	ThroughputInfo          *ResourceAiSearchEndpointThroughputInfo `json:"throughput_info,omitempty"`
