...
type DataSourcePostgresSyncedTableSpecTypeOverrides struct {
	ColumnName string `json:"column_name"`
	PgType     string `json:"pg_type"`
	Size       int    `json:"size,omitempty"`
}

type DataSourcePostgresSyncedTableSpec struct {
	...
	TypeOverrides                  []DataSourcePostgresSyncedTableSpecTypeOverrides  `json:"type_overrides,omitempty"`
}

type DataSourcePostgresSyncedTableStatusLastSyncDeltaTableSyncInfo struct {
	DeltaCommitTime    string `json:"delta_commit_time,omitempty"`
	DeltaCommitVersion int    `json:"delta_commit_version,omitempty"`
}

type DataSourcePostgresSyncedTableStatusLastSync struct {
	DeltaTableSyncInfo *DataSourcePostgresSyncedTableStatusLastSyncDeltaTableSyncInfo `json:"delta_table_sync_info,omitempty"`
	SyncEndTime        string                                                         `json:"sync_end_time,omitempty"`
	SyncStartTime      string                                                         `json:"sync_start_time,omitempty"`
}

type DataSourcePostgresSyncedTableStatusOngoingSyncProgress struct {
...
type DataSourcePostgresSyncedTableStatus struct {
	...
	LastSync                      *DataSourcePostgresSyncedTableStatusLastSync            `json:"last_sync,omitempty"`
...
type DataSourcePostgresSyncedTable struct {
	CreateTime     string                                       `json:"create_time,omitempty"`
	Name           string                                       `json:"name"`
	ProviderConfig *DataSourcePostgresSyncedTableProviderConfig `json:"provider_config,omitempty"`
	Spec           *DataSourcePostgresSyncedTableSpec           `json:"spec,omitempty"`
	Status         *DataSourcePostgresSyncedTableStatus         `json:"status,omitempty"`
