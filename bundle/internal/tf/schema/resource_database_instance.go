...
type ResourceDatabaseInstanceChildInstanceRefs struct {
...
type ResourceDatabaseInstanceCustomTags struct {
	Key   string `json:"key,omitempty"`
	Value string `json:"value,omitempty"`
}

type ResourceDatabaseInstanceEffectiveCustomTags struct {
	Key   string `json:"key,omitempty"`
	Value string `json:"value,omitempty"`
}

type ResourceDatabaseInstanceParentInstanceRef struct {
	BranchTime   string `json:"branch_time,omitempty"`
	EffectiveLsn string `json:"effective_lsn,omitempty"`
	Lsn          string `json:"lsn,omitempty"`
	Name         string `json:"name,omitempty"`
...
type ResourceDatabaseInstance struct {
	...
	CustomTags                         []ResourceDatabaseInstanceCustomTags          `json:"custom_tags,omitempty"`
	EffectiveCapacity                  string                                        `json:"effective_capacity,omitempty"`
	EffectiveCustomTags                []ResourceDatabaseInstanceEffectiveCustomTags `json:"effective_custom_tags,omitempty"`
