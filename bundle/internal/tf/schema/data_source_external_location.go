...
type DataSourceExternalLocationExternalLocationInfoEffectiveFileEventQueueManagedAqs struct {
...
type DataSourceExternalLocationExternalLocationInfoEffectiveFileEventQueueManagedPubsub struct {
	ManagedResourceId string `json:"managed_resource_id,omitempty"`
	SubscriptionName  string `json:"subscription_name,omitempty"`
}

type DataSourceExternalLocationExternalLocationInfoEffectiveFileEventQueueManagedSqs struct {
	ManagedResourceId string `json:"managed_resource_id,omitempty"`
	QueueUrl          string `json:"queue_url,omitempty"`
}

type DataSourceExternalLocationExternalLocationInfoEffectiveFileEventQueueProvidedAqs struct {
	ManagedResourceId string `json:"managed_resource_id,omitempty"`
	QueueUrl          string `json:"queue_url,omitempty"`
	ResourceGroup     string `json:"resource_group,omitempty"`
	SubscriptionId    string `json:"subscription_id,omitempty"`
...
type DataSourceExternalLocationExternalLocationInfoEffectiveFileEventQueueProvidedPubsub struct {
	ManagedResourceId string `json:"managed_resource_id,omitempty"`
	SubscriptionName  string `json:"subscription_name,omitempty"`
}

type DataSourceExternalLocationExternalLocationInfoEffectiveFileEventQueueProvidedSqs struct {
	ManagedResourceId string `json:"managed_resource_id,omitempty"`
	QueueUrl          string `json:"queue_url,omitempty"`
}

type DataSourceExternalLocationExternalLocationInfoEffectiveFileEventQueue struct {
	ManagedAqs     *DataSourceExternalLocationExternalLocationInfoEffectiveFileEventQueueManagedAqs     `json:"managed_aqs,omitempty"`
	ManagedPubsub  *DataSourceExternalLocationExternalLocationInfoEffectiveFileEventQueueManagedPubsub  `json:"managed_pubsub,omitempty"`
	ManagedSqs     *DataSourceExternalLocationExternalLocationInfoEffectiveFileEventQueueManagedSqs     `json:"managed_sqs,omitempty"`
	ProvidedAqs    *DataSourceExternalLocationExternalLocationInfoEffectiveFileEventQueueProvidedAqs    `json:"provided_aqs,omitempty"`
	ProvidedPubsub *DataSourceExternalLocationExternalLocationInfoEffectiveFileEventQueueProvidedPubsub `json:"provided_pubsub,omitempty"`
	ProvidedSqs    *DataSourceExternalLocationExternalLocationInfoEffectiveFileEventQueueProvidedSqs    `json:"provided_sqs,omitempty"`
}
...
type DataSourceExternalLocationExternalLocationInfo struct {
	...
	EffectiveFileEventQueue   *DataSourceExternalLocationExternalLocationInfoEffectiveFileEventQueue `json:"effective_file_event_queue,omitempty"`
