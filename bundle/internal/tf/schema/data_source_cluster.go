...
type DataSourceClusterClusterInfoSpec struct {
	...
	DriverNodeTypeFlexibility  *DataSourceClusterClusterInfoSpecDriverNodeTypeFlexibility `json:"driver_node_type_flexibility,omitempty"`
	...
	WorkerNodeTypeFlexibility  *DataSourceClusterClusterInfoSpecWorkerNodeTypeFlexibility `json:"worker_node_type_flexibility,omitempty"`
...
type DataSourceClusterClusterInfo struct {
	...
	DriverNodeTypeFlexibility  *DataSourceClusterClusterInfoDriverNodeTypeFlexibility `json:"driver_node_type_flexibility,omitempty"`
	...
	WorkerNodeTypeFlexibility  *DataSourceClusterClusterInfoWorkerNodeTypeFlexibility `json:"worker_node_type_flexibility,omitempty"`
