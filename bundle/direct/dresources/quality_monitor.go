...
func (r *ResourceQualityMonitor) DoCreate(ctx context.Context, _ *Engine, config *QualityMonitorState) (string, *catalog.MonitorInfo, error) {
...
func (r *ResourceQualityMonitor) DoUpdate(ctx context.Context, _ *Engine, id string, config *QualityMonitorState, _ *PlanEntry) (*catalog.MonitorInfo, error) {
