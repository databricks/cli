...
func (r *ResourceDashboard) DoUpdateWithChanges(ctx context.Context, id string, config *resources.DashboardConfig, _ *deployplan.Changes) (*resources.DashboardConfig, error) {
	dashboard, err := prepareDashboardRequest(config)
	if err != nil {
		return nil, err
	}
