...
func (r *ResourceDatabaseCatalog) DoUpdate(ctx context.Context, _ *Engine, id string, config *database.DatabaseCatalog, _ *PlanEntry) (*database.DatabaseCatalog, error) {
