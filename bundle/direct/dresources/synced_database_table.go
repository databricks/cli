...
func (r *ResourceSyncedDatabaseTable) DoUpdate(ctx context.Context, _ *StateSaver, id string, config *database.SyncedDatabaseTable, _ *PlanEntry) (*database.SyncedDatabaseTable, error) {
