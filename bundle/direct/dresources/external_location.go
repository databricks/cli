...
func (r *ResourceExternalLocation) DoCreate(ctx context.Context, _ *StateSaver, config *catalog.CreateExternalLocation) (string, *catalog.ExternalLocationInfo, error) {
...
func (r *ResourceExternalLocation) DoUpdate(ctx context.Context, _ *StateSaver, id string, config *catalog.CreateExternalLocation, _ *PlanEntry) (*catalog.ExternalLocationInfo, error) {
