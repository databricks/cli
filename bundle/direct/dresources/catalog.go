...
func (r *ResourceCatalog) DoCreate(ctx context.Context, _ *StateSaver, config *catalog.CreateCatalog) (string, *catalog.CatalogInfo, error) {
...
func (r *ResourceCatalog) DoUpdate(ctx context.Context, _ *StateSaver, id string, config *catalog.CreateCatalog, _ *PlanEntry) (*catalog.CatalogInfo, error) {
