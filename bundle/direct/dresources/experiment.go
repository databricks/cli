...
func (r *ResourceExperiment) DoCreate(ctx context.Context, _ *StateSaver, config *ml.CreateExperiment) (string, *ml.Experiment, error) {
...
func (r *ResourceExperiment) DoUpdate(ctx context.Context, _ *StateSaver, id string, config *ml.CreateExperiment, _ *PlanEntry) (*ml.Experiment, error) {
