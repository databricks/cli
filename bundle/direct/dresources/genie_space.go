...
func (r *ResourceGenieSpace) OverrideChangeDesc(_ context.Context, path *structpath.PathNode, change *ChangeDesc, _ *resources.GenieSpaceConfig, _ *resources.GenieSpaceConfig) error {
	switch path.String() {
	case "etag":
