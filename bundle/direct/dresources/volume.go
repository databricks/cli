...
func (r *ResourceVolume) DoUpdateWithChanges(ctx context.Context, id string, config *catalog.CreateVolumeRequestContent, _ *deployplan.Changes) (*catalog.VolumeInfo, error) {
