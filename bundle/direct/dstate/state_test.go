...
func TestOpenSaveFinalizeRoundTrip(t *testing.T) {
	...
	require.NoError(t, db.Open(t.Context(), path, WithRecovery(true), WithWrite(true), nil, WithDeploymentHistory(false), ""))
	...
	require.NoError(t, db2.Open(t.Context(), path, WithRecovery(false), WithWrite(false), nil, WithDeploymentHistory(false), ""))
...
func TestPanicOnDoubleOpen(t *testing.T) {
	...
	assert.Panics(t, func() {
		_ = db.Open(t.Context(), path, WithRecovery(true), WithWrite(true), nil, WithDeploymentHistory(false), "")
	})
	mustFinalize(t, &db)
}
...
func TestCLIVersionRecordsLastWriter(t *testing.T) {
	...
	require.NoError(t, reopened.Open(t.Context(), path, WithRecovery(false), WithWrite(false), nil, WithDeploymentHistory(false), ""))
...
func TestHeaderOnlyWALDoesNotUpdateCLIVersion(t *testing.T) {
	...
	require.NoError(t, recovered.Open(t.Context(), path, WithRecovery(true), WithWrite(false), nil, WithDeploymentHistory(false), ""))
...
func TestHeaderOnlyWALRecoveryDoesNotAdvanceSerial(t *testing.T) {
	...
	require.NoError(t, committed.Open(t.Context(), path, WithRecovery(false), WithWrite(false), nil, WithDeploymentHistory(false), ""))
...
func TestDeleteState(t *testing.T) {
	...
	var db2 DeploymentState
	require.NoError(t, db2.Open(t.Context(), path, WithRecovery(true), WithWrite(true), nil, WithDeploymentHistory(false), ""))
	require.NoError(t, db2.DeleteState(t.Context(), "jobs.my_job", false))
	mustFinalize(t, &db2)

	var db3 DeploymentState
	require.NoError(t, db3.Open(t.Context(), path, WithRecovery(false), WithWrite(false), nil, WithDeploymentHistory(false), ""))
...
func TestGetOrInitLineageReadableBeforeWriteAndPersisted(t *testing.T) {
	...
	// lineage yet.
	var db DeploymentState
	require.NoError(t, db.Open(t.Context(), path, WithRecovery(true), WithWrite(false), nil, WithDeploymentHistory(false), ""))
...
func TestOpenFailureLeavesStateClosed(t *testing.T) {
	...
	var db DeploymentState
	require.Error(t, db.Open(t.Context(), path, WithRecovery(true), WithWrite(true), nil, WithDeploymentHistory(false), ""))
