...
- - `keyvault_metadata`
  - Map
  - See [\_](#resourcessecret_scopesnamekeyvault_metadata).
...
- - `permissions`
  - Sequence
  - See [\_](#resourcessecret_scopesnamepermissions).
...
- - `keyvault_metadata`
  - Map
  - See [\_](#targetsnameresourcessecret_scopesnamekeyvault_metadata).
...
- - `permissions`
  - Sequence
  - See [\_](#targetsnameresourcessecret_scopesnamepermissions).
