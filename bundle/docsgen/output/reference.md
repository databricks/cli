...
- - `pipelines`
  - Map
  - The pipeline definitions for the bundle, where each key is the name of the pipeline. See [\_](/dev-tools/bundles/resources.md#pipelines). See [\_](#resourcespipelines).
...
- - `postgres_catalogs`
  - Map
  - The Postgres catalog definitions for the bundle, where each key is the name of the catalog. Each entry binds a Unity Catalog catalog to a Postgres database on a Lakebase Autoscaling branch. See [\_](#resourcespostgres_catalogs).
  
- - `postgres_databases`
  - Map
  - See [\_](#resourcespostgres_databases).
...
- - `postgres_roles`
  - Map
  - See [\_](#resourcespostgres_roles).
  
- - `postgres_synced_tables`
  - Map
  - The Postgres synced table definitions for the bundle, where each key is the name of the synced table. Each entry continuously replicates a Unity Catalog Delta source table into a Postgres table on a Lakebase Autoscaling instance. See [\_](#resourcespostgres_synced_tables).
...
- - `vector_search_endpoints`
  - Map
  - See [\_](#resourcesvector_search_endpoints).
  
- - `vector_search_indexes`
  - Map
  - See [\_](#resourcesvector_search_indexes).
...
- - `managed_encryption_settings`
  - Map
  - See [\_](#resourcescatalogsnamemanaged_encryption_settings).
...
- - `effective_file_event_queue`
  - Map
  - See [\_](#resourcesexternal_locationsnameeffective_file_event_queue).
...
- - `clusters`
  - Sequence
  - See [\_](#resourcespipelinesnameclusters).
...
- - `deployment`
  - Map
  - See [\_](#resourcespipelinesnamedeployment).
...
- - `environment`
  - Map
  - See [\_](#resourcespipelinesnameenvironment).
  
- - `event_log`
  - Map
  - See [\_](#resourcespipelinesnameevent_log).
  
- - `filters`
  - Map
  - See [\_](#resourcespipelinesnamefilters).
  
- - `gateway_definition`
  - Map
  - See [\_](#resourcespipelinesnamegateway_definition).
...
- - `ingestion_definition`
  - Map
  - See [\_](#resourcespipelinesnameingestion_definition).
  
- - `libraries`
  - Sequence
  - See [\_](#resourcespipelinesnamelibraries).
  
- - `lifecycle`
  - Map
  - See [\_](#resourcespipelinesnamelifecycle).
...
- - `notifications`
  - Sequence
  - See [\_](#resourcespipelinesnamenotifications).
...
- - `permissions`
  - Sequence
  - See [\_](#resourcespipelinesnamepermissions).
...
- - `restart_window`
  - Map
  - See [\_](#resourcespipelinesnamerestart_window).
...
- - `run_as`
  - Map
  - See [\_](#resourcespipelinesnamerun_as).
...
- - `trigger`
  - Map
  - See [\_](#resourcespipelinesnametrigger).
...
### resources.pipelines._name_.lifecycle
...
### resources.pipelines._name_.permissions
...
- - `lifecycle`
  - Map
  - See [\_](#resourcespostgres_catalogsnamelifecycle).
...
### resources.postgres_catalogs._name_.lifecycle
...
- - `lifecycle`
  - Map
  - See [\_](#resourcespostgres_databasesnamelifecycle).
...
### resources.postgres_databases._name_.lifecycle
...
- - `attributes`
  - Map
  - The desired API-exposed Postgres role attributes to associate with the role. See [\_](#resourcespostgres_rolesnameattributes).
...
- - `lifecycle`
  - Map
  - See [\_](#resourcespostgres_rolesnamelifecycle).
...
### resources.postgres_roles._name_.lifecycle
...
- - `lifecycle`
  - Map
  - See [\_](#resourcespostgres_synced_tablesnamelifecycle).
  
- - `new_pipeline_spec`
  - Map
  - See [\_](#resourcespostgres_synced_tablesnamenew_pipeline_spec).
...
### resources.postgres_synced_tables._name_.lifecycle
...
- - `lifecycle`
  - Map
  - See [\_](#resourcesvector_search_endpointsnamelifecycle).
...
- - `permissions`
  - Sequence
  - See [\_](#resourcesvector_search_endpointsnamepermissions).
...
### resources.vector_search_endpoints._name_.lifecycle
...
### resources.vector_search_endpoints._name_.permissions
...
- - `delta_sync_index_spec`
  - Map
  - See [\_](#resourcesvector_search_indexesnamedelta_sync_index_spec).
  
- - `direct_access_index_spec`
  - Map
  - See [\_](#resourcesvector_search_indexesnamedirect_access_index_spec).
...
- - `grants`
  - Sequence
  - See [\_](#resourcesvector_search_indexesnamegrants).
...
- - `lifecycle`
  - Map
  - See [\_](#resourcesvector_search_indexesnamelifecycle).
...
### resources.vector_search_indexes._name_.lifecycle
...
- - `pipelines`
  - Map
  - The pipeline definitions for the bundle, where each key is the name of the pipeline. See [\_](/dev-tools/bundles/resources.md#pipelines). See [\_](#targetsnameresourcespipelines).
...
- - `postgres_catalogs`
  - Map
  - The Postgres catalog definitions for the bundle, where each key is the name of the catalog. Each entry binds a Unity Catalog catalog to a Postgres database on a Lakebase Autoscaling branch. See [\_](#targetsnameresourcespostgres_catalogs).
  
- - `postgres_databases`
  - Map
  - See [\_](#targetsnameresourcespostgres_databases).
...
- - `postgres_roles`
  - Map
  - See [\_](#targetsnameresourcespostgres_roles).
  
- - `postgres_synced_tables`
  - Map
  - The Postgres synced table definitions for the bundle, where each key is the name of the synced table. Each entry continuously replicates a Unity Catalog Delta source table into a Postgres table on a Lakebase Autoscaling instance. See [\_](#targetsnameresourcespostgres_synced_tables).
...
- - `vector_search_endpoints`
  - Map
  - See [\_](#targetsnameresourcesvector_search_endpoints).
  
- - `vector_search_indexes`
  - Map
  - See [\_](#targetsnameresourcesvector_search_indexes).
...
- - `managed_encryption_settings`
  - Map
  - See [\_](#targetsnameresourcescatalogsnamemanaged_encryption_settings).
...
- - `effective_file_event_queue`
  - Map
  - See [\_](#targetsnameresourcesexternal_locationsnameeffective_file_event_queue).
...
### targets._name_.resources.pipelines
...
- - `clusters`
  - Sequence
  - See [\_](#targetsnameresourcespipelinesnameclusters).
...
- - `deployment`
  - Map
  - See [\_](#targetsnameresourcespipelinesnamedeployment).
...
- - `environment`
  - Map
  - See [\_](#targetsnameresourcespipelinesnameenvironment).
  
- - `event_log`
  - Map
  - See [\_](#targetsnameresourcespipelinesnameevent_log).
  
- - `filters`
  - Map
  - See [\_](#targetsnameresourcespipelinesnamefilters).
  
- - `gateway_definition`
  - Map
  - See [\_](#targetsnameresourcespipelinesnamegateway_definition).
...
- - `ingestion_definition`
  - Map
  - See [\_](#targetsnameresourcespipelinesnameingestion_definition).
  
- - `libraries`
  - Sequence
  - See [\_](#targetsnameresourcespipelinesnamelibraries).
  
- - `lifecycle`
  - Map
  - See [\_](#targetsnameresourcespipelinesnamelifecycle).
...
- - `notifications`
  - Sequence
  - See [\_](#targetsnameresourcespipelinesnamenotifications).
...
- - `permissions`
  - Sequence
  - See [\_](#targetsnameresourcespipelinesnamepermissions).
...
- - `restart_window`
  - Map
  - See [\_](#targetsnameresourcespipelinesnamerestart_window).
...
- - `run_as`
  - Map
  - See [\_](#targetsnameresourcespipelinesnamerun_as).
...
- - `trigger`
  - Map
  - See [\_](#targetsnameresourcespipelinesnametrigger).
...
### targets._name_.resources.pipelines._name_.lifecycle
...
### targets._name_.resources.pipelines._name_.permissions
...
### targets._name_.resources.postgres_catalogs
...
- - `lifecycle`
  - Map
  - See [\_](#targetsnameresourcespostgres_catalogsnamelifecycle).
...
### targets._name_.resources.postgres_catalogs._name_.lifecycle
...
### targets._name_.resources.postgres_databases
...
- - `lifecycle`
  - Map
  - See [\_](#targetsnameresourcespostgres_databasesnamelifecycle).
...
### targets._name_.resources.postgres_databases._name_.lifecycle
...
### targets._name_.resources.postgres_roles
...
- - `attributes`
  - Map
  - The desired API-exposed Postgres role attributes to associate with the role. See [\_](#targetsnameresourcespostgres_rolesnameattributes).
...
- - `lifecycle`
  - Map
  - See [\_](#targetsnameresourcespostgres_rolesnamelifecycle).
...
### targets._name_.resources.postgres_roles._name_.lifecycle
...
### targets._name_.resources.postgres_synced_tables
...
- - `lifecycle`
  - Map
  - See [\_](#targetsnameresourcespostgres_synced_tablesnamelifecycle).
  
- - `new_pipeline_spec`
  - Map
  - See [\_](#targetsnameresourcespostgres_synced_tablesnamenew_pipeline_spec).
...
### targets._name_.resources.postgres_synced_tables._name_.lifecycle
...
### targets._name_.resources.vector_search_endpoints
...
- - `lifecycle`
  - Map
  - See [\_](#targetsnameresourcesvector_search_endpointsnamelifecycle).
...
- - `permissions`
  - Sequence
  - See [\_](#targetsnameresourcesvector_search_endpointsnamepermissions).
...
### targets._name_.resources.vector_search_endpoints._name_.lifecycle
...
### targets._name_.resources.vector_search_endpoints._name_.permissions
...
### targets._name_.resources.vector_search_indexes
...
- - `delta_sync_index_spec`
  - Map
  - See [\_](#targetsnameresourcesvector_search_indexesnamedelta_sync_index_spec).
  
- - `direct_access_index_spec`
  - Map
  - See [\_](#targetsnameresourcesvector_search_indexesnamedirect_access_index_spec).
...
- - `grants`
  - Sequence
  - See [\_](#targetsnameresourcesvector_search_indexesnamegrants).
...
- - `lifecycle`
  - Map
  - See [\_](#targetsnameresourcesvector_search_indexesnamelifecycle).
...
### targets._name_.resources.vector_search_indexes._name_.lifecycle
