...
The pipeline resource allows you to create Delta Live Tables [pipelines](/api/workspace/pipelines/create). For information about pipelines, see [_](/dlt/index.md). For a tutorial that uses the DABs template to create a pipeline, see [_](/dev-tools/bundles/pipelines-tutorial.md).
