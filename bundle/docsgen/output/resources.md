...
- - `effective_run_as`
  - Map
  - See [\_](#alertsnameeffective_run_as).
...
- - `child_instance_refs`
  - Sequence
  - See [\_](#database_instancesnamechild_instance_refs).
